...
public class MazoServices {
    ...
    //imprimo los diferentes mazos de cartas creados
        public void imprimir(Map<Integer, Carta> baraja) {
        if (baraja.equals(mazo)) {
            for (Map.Entry<Integer, Carta> aux : mazo.entrySet()) {
                Integer key = aux.getKey();
                Carta value = aux.getValue();
                System.out.println("key: " + key + " value: " + value);
                }
            }else if (baraja.equals(mazoMezclado)) {
                    for (Map.Entry<Integer, Carta> aux : mazoMezclado.entrySet()) {
                        Integer key = aux.getKey();
                        Carta value = aux.getValue();
                        System.out.println("key: " + key + " value: " + value);
                    }
                    }else if (baraja.equals(cartaMonton)) {
